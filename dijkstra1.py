"""
Exemplo de algoritmo ganâncioso - Dijakstra.
Solução do Caminho mais Curto.
"""


# 1. Denifir: representar o grafo (mapa) e a tabela de soluções
DISTANCE = 0
PREDECESSOR = 1
INFINITY = float("inf")
...
def get_shortest_distance(table: dict, vertex: str) -> int:
    """
    Retorna a distância mais curta de um vértice a partir da origem.
    """
